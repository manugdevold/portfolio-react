    ...
    <section name='contact' className='w-full min-h-screen flex justify-center items-center p-4 mt-12 sm:mt-0 sm:h-screen'>
      <form onSubmit={handleSubmit} className='flex flex-col max-w-[1000px] w-full'>
        ...
        <div className='flex flex-col max-w-[600px] m-auto w-full'>
          ...
          <input 
            className='my-4 p-3 bg-[#063A51] rounded-md focus:outline-none focus:ring' 
            type='email' 
            name='email'
            placeholder='Email' 
            value={values.email}
            onChange={handleInputChange} />
          <textarea 
            className='bg-[#063A51] resize-none p-3 rounded-md focus:outline-none focus:ring' 
            name='message' 
            rows='10' 
            placeholder='Message'
          ...
          <button type='submit' className='border-2 border-[#063A51] px-10 py-2 mt-8 mx-auto flex items-center rounded-md hover:bg-[#063A51] hover:shadow-lg hover:shadow-[#000D19]'>
            { !nav ? '': 
